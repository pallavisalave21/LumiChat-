...
- 🎨 Blush pink aesthetic UI with glassmorphism design
...
3. Enter your Gemini API key in the script file
4. Start chatting!

## ⚠️ Note
If the API quota is exceeded, the chatbot will automatically switch to fallback responses.
